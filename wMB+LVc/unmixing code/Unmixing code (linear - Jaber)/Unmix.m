...
for slice_idx=1:slicNum
    ...
    spectraPath = 'C:\Users\marwan.muhammad\Dropbox\PA_imaging\Unmixing code (linear - Jaber)\SpectralSpecifications1'; % path to agents , oxy- and deoxy-hemoglobin spectra
