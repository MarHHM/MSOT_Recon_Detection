function recon_single_msot_scan(scan_path, NON_NEG, recon_lims, RECON_ALL, addtnl_note)
%% VIPs:
...
disp("using sos for heavy water!!");
c = 1465;
% c = 1400;       % for heavy water as per Hong's paper (for 'Qutaiba\Study_4') --> SUSPECTED
% c = 1530;
