function Ri = xvue_calc_Ri(kk,N_x,N_y,thres,depth_im,wl_name)
...
% - wl_name:    Name of the wavelet base (e.g. 'db6')
    ...
    [temp,L4]=wavedec2cl(ones(N_x,N_y),depth_im,LO_D,HI_D);
    clear temp;

    % get base and inverse for selected base
    base=return_base_arb_lev_even_db(kk,depth_im,LO_R,HI_R );
...
function [base ] = return_base_arb_lev_even_db(lev_n,depth,LO_R,HI_R)  %calculates the wavelet reconstruction matrix 
